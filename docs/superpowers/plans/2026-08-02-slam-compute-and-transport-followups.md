...
| CUDA at-scale validation on the rig | GPU median 8.85 ms vs CPU 18.94 ms (~2.1×); GPU degradation flat while CPU climbed | [BUG-035](https://github.com/hellosamblack/lidar-roomscanner/issues/46); re-run after any compute-path change |
