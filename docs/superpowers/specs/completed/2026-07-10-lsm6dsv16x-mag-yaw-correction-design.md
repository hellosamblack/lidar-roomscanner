...
**Date:** 2026-07-10
**Status:** ✅ shipped — merged via PR #2 (`33b7796`). The original 2026-07-10
`AXIS_CONVENTION` check was invalidated by BUG-059 because `|B|` cannot distinguish signed axis
permutations; the current dip-validated mapping is recorded in `ROADMAP.md` Phase 4.
**Depends on:** the shipped LSM6DSV16X panel integration (`docs/superpowers/specs/completed/2026-07-09-lsm6dsv16x-orientation-env-panel-design.md`).
