...
| `set_display` | `display`(point_cloud\|slam\|detailed) | select the shared display. Detailed is View-only; SLAM choices reject a capture without stream 9 | Live/View |
