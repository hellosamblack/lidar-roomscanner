...
| Phase 7 — Offline post-processing | 🔜 Future → [#132](https://github.com/hellosamblack/lidar-roomscanner/issues/132), reshaped by the RTAB-Map decision ([#158](https://github.com/hellosamblack/lidar-roomscanner/issues/158)) |
