 ...
 */
int vl53l9_utils_get_frame_resolution(uint8_t binning, uint16_t *p_width, uint16_t *p_height);

/**
 * @brief Get the I3C resolution depending on the binning value
 * @param[in] binning The binning value
 * @param[out] p_width The width of the I3C frame
 * @param[out] p_height The height of the I3C frame
 * @return 0 in case of success, -1 otherwise
 */
int vl53l9_utils_get_i3c_resolution(uint8_t binning, uint16_t *p_width, uint16_t *p_height);
 ...
 */
int vl53l9_utils_get_csi_resolution(uint8_t binning, uint16_t *p_width, uint16_t *p_height);
