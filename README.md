...
*   [**`ROADMAP.md`**](ROADMAP.md) - The phased implementation plan and source of truth for sequencing tasks, milestones, and architectural decisions.
*   [**`BUGS.md`**](BUGS.md) - Bug tracker for host and firmware issues.
