...
EXPOSED: dict[str, tuple[str, ...]] = {
    ...
    "pcap2capture.py": ("bridge_pcap_convert", "bridge_tee_fetch"),
    "pi_bridge.py": ("bridge_status", "bridge_logs", "bridge_wifi_update",
                     "bridge_update", "bridge_tee_list", "bridge_tee_fetch",
                     "bridge_reboot"),
    "operator_page.py": ("operator_page",),
